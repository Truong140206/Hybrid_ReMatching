...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--rp_class_fusion_gate', default='none', type=str, choices=['none', 'margin', 'entropy'], help="scale the class-fusion weight per sample by how undecided the routed head is; 'margin' uses its normalised top-2 margin, 'entropy' its normalised entropy, 'none' fuses every sample equally")
