...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--rp_lambda_criterion', default='mse', type=str, choices=['mse', 'cosine'], help="what the lambda sweep optimises; 'mse' is RanPAC's held-out squared error, 'cosine' is the scale-invariant Frobenius cosine between predictions and targets, which does not reward the magnitude shrinkage that large lambda buys and that the per-sample standardisation in the blend discards anyway")
