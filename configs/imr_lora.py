...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--cfs_pmi_diag_classes', default=2, type=int)
    subparsers.add_argument('--cfs_pmi_diag_targets_per_class', default=4, type=int)
    subparsers.add_argument('--cfs_pmi_diag_real_samples_per_class', default=64, type=int)
    subparsers.add_argument('--cfs_pmi_diag_cfs_epochs', default=50, type=int)
    subparsers.add_argument('--cfs_pmi_diag_split_block', default=5, type=int)
    subparsers.add_argument('--cfs_pmi_diag_layer_steps', default=20, type=int)
    subparsers.add_argument('--cfs_pmi_diag_full_steps', default=40, type=int)
