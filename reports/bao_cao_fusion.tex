...
Bản gốc xác nhận điều này là có cơ sở. Phần thí nghiệm của bài viết rằng họ dùng
\emph{hai} mô hình ViT-B/16: một tiền huấn luyện trên ImageNet-21K, một tinh
chỉnh có giám sát trên ImageNet-1K. Chú thích của cả hai bảng kết quả đều không
ghi bảng nào dùng checkpoint nào, và cũng không tuyên bố lấy kết quả tốt hơn
giữa hai bản. Phép so sánh vì vậy chưa bao giờ được bảo đảm là cùng điều kiện, và
chính phép đo ở Bảng \ref{tab:backbone} mới là thứ xác định được checkpoint: bản
tinh chỉnh trên ImageNet-1K tái lập con số công bố tới $0.43$ điểm, còn bản $21$K
thuần kém $13.6$ điểm.
