...
Chúng tôi đã loại trừ năm nguyên nhân bằng thí nghiệm trực tiếp: dữ liệu không
...
tự của $G$ và $C$); không phải do $\lambda$ (đã quét $\{10^2,\dots,10^6\}$, cực
đại nội tại đạt $58.10$); và không phải do tăng cường dữ liệu làm nhiễu thống kê
(thống kê được tích lũy trên biến đổi tất định, đúng như RanPAC).

\textbf{Một nguyên nhân còn lại, và chúng tôi chưa đo nó trên ImageNet-R.} Hàm
dựng biến đổi ảnh của mã nguồn gọi \texttt{ToTensor} mà không gọi
\texttt{Normalize}, nên ảnh nằm trong khoảng $[0,1]$, trong khi checkpoint
ViT-B/16 ImageNet-21K được huấn luyện trên khoảng $[-1,1]$. HRM-PET miễn nhiễm vì
nó huấn luyện trên chính những đặc trưng bị lệch đó; một đầu phân lớp không huấn
luyện thì không. Chúng tôi có sẵn tùy chọn sửa khoảng giá trị, nhưng nó
\emph{mặc định tắt}, nên mọi số ở Bảng \ref{tab:nophase1} đều đo khi lỗi này còn
nguyên. Ở bộ dữ liệu duy nhất đã đo, sửa lại đem về $+2.7$ điểm trên đặc trưng
đóng băng của CUB-200 --- lớn hơn chính khoảng cách $2$ điểm của CUB-200 với
RanPAC. ImageNet-R là nơi chịu ảnh hưởng nặng nhất theo lập luận, vì ảnh cách
điệu vốn đã xa phân bố tiền huấn luyện nên sai khoảng giá trị chồng thêm chứ
không được hấp thụ, nhưng đó vẫn là lập luận: phép đo tương ứng chưa được chạy.
Chúng tôi vì vậy \emph{không} tuyên bố đã loại trừ nguyên nhân này.
...
phương nhỏ nhất trên phần giữ lại, không đụng dữ liệu tác vụ cũ. Cách tính sai số kiểm
định của chúng tôi bám đúng công thức đó, nhưng \textbf{phạm vi dữ liệu thì
không}: bộ thống kê $80{:}20$ của chúng tôi cộng dồn qua \emph{mọi} tác vụ đã
gặp, trong khi bài gốc dựng lại nó từ đầu trên riêng tác vụ hiện tại. Đây là một
sai lệch thật, và nó lệch theo đúng hướng đã quan sát: chuẩn của $G$ tăng tuyến
tính theo số mẫu, mà nghiệm ridge tối ưu tăng theo chuẩn của $G$, nên quét trên
mười tác vụ gộp lại sẽ thiên về $\lambda$ lớn hơn quét trên một tác vụ. Con số
được chọn nằm gần đỉnh dải quét, phù hợp với thiên lệch này. Kết quả dưới đây vì
vậy là của \emph{biến thể} quy trình, không phải của quy trình gốc. Sai số kiểm
định khai triển được thành
...
Tuy nhiên đó không còn là cách giải thích duy nhất, và chúng tôi chưa tách được
hai khả năng. Cả hai tiêu chí đều được tính trên cùng một bộ thống kê gộp, nên
sai lệch phạm vi nêu ở trên tác động y hệt lên cả hai --- việc chúng đồng ý với
nhau vì thế không nói được gì về chuyện phép gộp có đẩy lựa chọn lên cao hay
không. Dựng lại thống kê giữ lại theo từng tác vụ, tức đúng quy trình của bài
gốc, là một thay đổi nhỏ và chưa được chạy. Chừng nào chưa chạy, phát biểu trung
thực là biến thể của chúng tôi chọn $10^5$ và kém $0.43$ điểm, chứ không phải
việc tự chọn nói chung thất bại ở đây.
