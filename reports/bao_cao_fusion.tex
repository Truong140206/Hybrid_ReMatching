...
Cách đếm này cần đọc kèm Mục \ref{sec:limits}: siêu tham số được chọn trên
ImageNet-R theo tiêu chí cùng dạng với chính phép đếm, nên $18$ ô không phải
$18$ bằng chứng độc lập. Phần độc lập là $11$ ô của CIFAR-100 và CUB-200, và cả
$11$ đều cải thiện.
...
Bảng \ref{tab:main} chính là đại lượng đã dùng để chọn $\beta$. Còn tiêu chí
chọn $w$ --- cải thiện đồng thời cả sáu chỉ số trên mọi seed --- cùng dạng với
cách đếm $17/18$: cấu hình được chọn để tối đa hóa số ô cải thiện, rồi số ô cải
thiện được báo cáo như một phát hiện. Cách đếm đó vì vậy không nên đọc như một
phép kiểm định độc lập.
