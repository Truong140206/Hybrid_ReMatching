...
đại nội tại đạt $58.10$); không phải do tăng cường dữ liệu làm nhiễu thống kê
(thống kê được tích lũy trên biến đổi tất định, đúng như RanPAC); và không phải
sai khoảng giá trị ảnh đầu vào.

Nguyên nhân cuối đáng nói rõ vì nó là một lỗi có thật của mã nguồn. Hàm dựng
biến đổi ảnh gọi \texttt{ToTensor} mà không gọi \texttt{Normalize}, nên ảnh nằm
trong khoảng $[0,1]$ trong khi checkpoint ViT-B/16 ImageNet-21K được huấn luyện
trên khoảng $[-1,1]$. HRM-PET miễn nhiễm vì nó huấn luyện trên chính những đặc
trưng bị lệch đó; một đầu phân lớp không huấn luyện thì không. Chúng tôi đã đo
trực tiếp cả hai phía trên ImageNet-R với bộ trích trần: để nguyên khoảng sai cho
Acc@1 $55.79$, sửa đúng khoảng cho $56.36$. Bản sửa vì vậy đáng $+0.56$ điểm ---
có thật, nhưng chỉ bằng một phần hai mươi bảy khoảng cách cần giải thích, và giá
trị $56.36$ ở Bảng \ref{tab:nophase1} vốn đã là con số \emph{đã sửa}. Cũng cần
lưu ý mức này nhỏ hơn hẳn $+2.7$ điểm mà cùng bản sửa đem lại trên CUB-200, nên
không thể suy từ một bộ dữ liệu sang bộ khác.
