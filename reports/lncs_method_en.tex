...
% The nine entries below were added with the Related Work section. Author lists
% for ref_coda, ref_adam, ref_icarl, ref_bic, ref_wa and ref_lucir were checked
% against the papers; ref_adam had been missing Z.-W. Cai and is now complete.
%
% STILL TO FILL: ref_dlepem has no author list. The publisher page refuses
% automated access and the authors do not appear in search results, so the field
% is deliberately blank rather than guessed. One look at
% https://www.mdpi.com/2076-3417/16/12/6153 in a browser closes it.
