...
Class-prototype kèm nghịch đảo Gram, công thức \eqref{eq:gram}
                                              & 75\,\% \\
...
Một hệ quả thú vị được xác nhận ở Phụ lục F: khi bỏ Phase 1, kết quả cuối cùng
gần như \emph{không dao động} dù đổi cách gán ngẫu nhiên lớp vào tác vụ. Khi có
Phase 1, dao động tăng lên rõ rệt -- vì Phase 1 dùng SGD, và SGD thì có ngẫu
nhiên.
...
\begin{table}[htbp]
\centering
\caption{Kết quả cho DIL (Bảng 3 của bài báo). CORe50 có 8 giai đoạn, CDDB-Hard
có 5, DomainNet có 6.}
\label{tab:dil}
\begin{tabular}{lrrr}
\toprule
...
miền đầu tiên, nên nó không giúp gì cho các miền sau vốn khác hẳn.
...
quả ổn định qua các seed, đặc biệt là gần như bất biến khi bỏ Phase 1, đúng như
tính chất đại số ở Mục \ref{sec:coloi}.
...
Ba điểm cần nhớ khi đối chiếu số liệu:
